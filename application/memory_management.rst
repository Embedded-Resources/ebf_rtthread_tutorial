...
被创建时，内存池对象就被分配给了一个内存池控制块，内存控制块的参数包括内存池名，内存缓冲区，内存块大小，块数以及一个等待线程列表。
...
另外，在每次分配内存块前，都会留出12字节数据头用于magic，used信息及链表节点使用。返回给应用的地址实际上是这块内存块12字节以后的地址，而数据头部分是用户永远不应该改变的部分。（注：12字节数据头长度会与系统对齐差异而有所不同）。
...
.. |memory002| image:: media/memory_management/memory002.png
   :width: 5.76806in
   :height: 2.60454in
.. |memory003| image:: media/memory_management/memory003.png
   :width: 5.76806in
   :height: 1.26754in
.. |memory004| image:: media/memory_management/memory004.png
   :width: 5.76806in
   :height: 2.93259in
.. |memory005| image:: media/memory_management/memory005.png
   :width: 5.76806in
   :height: 0.92476in
.. |memory006| image:: media/memory_management/memory006.png
   :width: 5.76806in
   :height: 0.90253in
.. |memory007| image:: media/memory_management/memory007.png
   :width: 4.92537in
   :height: 2.73426in
.. |memory008| image:: media/memory_management/memory008.png
   :width: 5.76806in
   :height: 1.28927in
.. |memory008| image:: media/memory_management/memory008.png
   :width: 5.76806in
   :height: 1.28963in
.. |memory009| image:: media/memory_management/memory009.png
   :width: 5.82639in
   :height: 2.30271in
.. |memory010| image:: media/memory_management/memory010.png
   :width: 5.76806in
   :height: 1.19057in
.. |memory011| image:: media/memory_management/memory011.png
   :width: 5.76806in
   :height: 2.84657in
.. |memory012| image:: media/memory_management/memory012.png
   :width: 5.76806in
   :height: 3.25895in
.. |memory013| image:: media/memory_management/memory013.png
   :width: 5.76806in
   :height: 1.83014in
.. |memory014| image:: media/memory_management/memory014.png
   :width: 5.76806in
   :height: 2.8554in
.. |memory015| image:: media/memory_management/memory015.png
   :width: 5.76806in
   :height: 2.83734in
